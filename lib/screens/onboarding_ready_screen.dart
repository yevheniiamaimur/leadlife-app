          ...
          children: [
            Column(
              ...
              children: [
                ...
                LLSmallCaps(l10n.onboardingStepOfFive(5), color: llGold),
                const Spacer(),
                ...
                Padding(
                  ...
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      Text(l10n.takeABreathIn, textAlign: TextAlign.center, style: llSerif(size: 26, height: 1.3)),
                      const SizedBox(height: 6),
                      Text(l10n.andOut, textAlign: TextAlign.center, style: llSerif(size: 26, height: 1.3)),
                      const SizedBox(height: 18),
                      Text(
                        l10n.onboardingReadyMessage(name),
