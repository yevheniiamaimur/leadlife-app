...
class AppLocalizationsUk extends AppLocalizations {
  ...
  String get field01Intro =>
      'Кожна подорож починається з бажання.\n\nТвоє бажання важливе, бо вказує на щось значуще для твого розвитку.';
  ...
  String get field04Intro =>
      'Кожна мета створює вплив.\nПодумай, яку цінність твоє бажання приносить іншим.';

  @override
  String get field04Task => 'Хто отримає користь, коли ти досягнеш цього?';
  ...
  String get field05Intro =>
      'Обмеження — природна частина кожної подорожі.\n\nВони допомагають розвинути силу, потрібну для досягнення мети.';

  @override
  String get field05Task =>
      'Які обмеження ти маєш зараз — фізичні, емоційні, фінансові, соціальні чи інші? Як вони допомагають тобі розвиватися?';
  ...
  String get field06Intro =>
      'Твої цінності спрямовують твої рішення.\n\nНайсильніші бажання часто пов’язані з тим, що завжди було для тебе важливим.';

  @override
  String get field06Task =>
      'Що завжди було важливим для тебе?\n\nЧи відображає це бажання твої цінності?\n\nЯкі якості були природними для тебе в дитинстві?\n\nЯкі з них досі живі в тобі?\n\nЯк вони можуть допомогти здійснити бажання?';
  ...
  String get field07Intro =>
      'Почуття — це сигнали, а не перешкоди.\n\nВони показують, що підтримує твоє бажання, а що потребує уваги.';

  @override
  String get field07Task =>
      'Які емоції ти відчуваєш найчастіше? Як вони впливають на твоє бажання?';
  ...
  String get field08Intro =>
      'Одні переконання підтримують кожне бажання, а інші обмежують його.\n\nЩо чіткіше ти їх бачиш, то більше свободи маєш у виборі шляху.';

  @override
  String get field08Task =>
      'Які переконання підтримують тебе, а які стримують?';
  ...
  String get field09Intro =>
      'Твоя підсвідомість зберігає план життя, якого ти бажаєш.';

  @override
  String get field09Task =>
      'Якби твоє бажання вже стало реальністю, яким було б твоє життя? Опиши його.';
  ...
  @override
  String get field10Intro => 'Реальність формується твоїми діями.';

  @override
  String get field10Task =>
      'Запиши 10 дій, які можеш зробити сьогодні, щоб наблизитися до мети.';
