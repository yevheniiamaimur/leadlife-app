...
const GAME_FIELDS: GameFieldInfo[] = [
  { n: 1, name: "Light", subtitle: "Desire", task: "" },
  ...
  { n: 11, name: "Possibility", subtitle: "Trust", task: "What possibilities for realizing your request can you already notice now? What helps you feel inner freedom, calmness, and trust in life in this process?" },
  { n: 12, name: "Will", subtitle: "Resourcefulness", task: "What resources do you already have to realize your wish? These can be qualities, knowledge, skills, money, connections, things, and anything else that can support realization." },
...
- Field 11, Possibility, is the first strategy field and is always about the process. It is the strategy of total inner freedom from everything, calmness, trust in life, and openness to an unlimited number of possibilities. The player notices possibilities, allows them, stays in the energy and flow of life, and trusts life. This strategy opens the wisdom of life and the connections happening within it. Generate a unique field question from this meaning and the player's request. In the final analysis, give a recommendation about trust in the process in the present moment, based on the player's answer, and emphasize the value of what the player has already noticed or allowed.
- Field 12, Will, is a strategy of the process where the player already has all resources for reaching the desired outcome, both internal and external. It is important for the player to decide what exactly they want to create, and through this decision and inner will activate both inner and outer resources. In the user-facing task, ask only which resources they already have, including qualities, knowledge, skills, money, connections, things, and anything that can support realization. In the final analysis, show the resources visible in the player's answer and recommend how to activate them through decision and inner will.`;
